export default class View {
    ...
    fillElements(element, x, y, btnSize) {
        ...
        this.context.fillText(element.number, x + btnSize - 20, y + btnSize - 20);
    ...
    renderEndScreen(time, guessBombCount) {
        this.context.fillStyle = "rgba(0, 0, 0, 0.75)";
        this.context.fillRect(0, 0, this.width, this.height);
        ...
        this.context.fillText(`Time: ${time}`, this.width / 2, this.height / 2);
        this.context.fillText(`Guessed Bombs: ${guessBombCount}`, this.width / 2, this.height / 2 + 48);
        this.context.fillText("Press ENTER to Restart", this.width / 2, this.height / 2 + 120);
    };
};